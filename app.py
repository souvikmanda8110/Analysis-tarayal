...
def convert_to_grade(predicted_grade):
    if predicted_grade < 0.2:
        return [
            'A - Excellent:', 
            '- Demonstrates outstanding understanding and mastery of the subject.'
        ]
    elif predicted_grade < 1:
        return [
            'B - Good:', 
            '- Shows above-average performance with room for improvement.'
        ]
    elif predicted_grade < 2:
        return [
            'C - Average:', 
            '- Meets basic requirements but may need additional support.'
        ]
    else:
        return [
            'Fail - Below Average', 
            '- The predicted grade should be between 0 and 1.'
        ]
